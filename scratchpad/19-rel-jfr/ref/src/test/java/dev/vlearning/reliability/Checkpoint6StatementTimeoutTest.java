 ...
 *
 * <p>The marker property below is not decoration: it gives this class its own
 * application context, so the rolling maximums recorded by the diagnosis test do
 * not leak into these assertions.
 */
@SpringBootTest(properties = "reliability.step=6b")
